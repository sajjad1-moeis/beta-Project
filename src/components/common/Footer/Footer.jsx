...
export default function Footer() {
   return (
      <div className='lg:p-responsive mt-14 lg:mt-44 relative'>
         <div className='absolute z-[555] size-8 xl:size-14 max-md:-top-6 xl:-top-5 left-[23%] sm:left-[21%] md:left-1/2 -translate-x-full max-2xl:-translate-x-[90%]  border border-primary bg-primary/15 rounded-full flex-center justify-center'>
            <ArrowCircleUp className='size-5 xl:size-9' color='#4156d9' variant='Bulk' />
         </div>

         <div className='max-md:p-6 p-7.5  rounded-b-5xl  relative'>
            <img
               src='/image/footerBgSm.png'
               className='absolute md:hidden right-0 size-full z-50 top-0 rounded-5xl'
               alt=''
            />
            <img
               src='/image/footerBgLg.png'
               className='absolute max-md:hidden right-0 size-full z-50 top-0 rounded-5xl'
               alt=''
            />

            <div className='relative z-50'>
               <div className='flex-center gap-10 relative z-50 md:mt-14'>
                  <div>
