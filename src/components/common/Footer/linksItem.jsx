...
export default function LinksItem() {
   return (
      <div className='grid xl:grid-cols-5 mt-12 gap-10 xl:gap-20'>
         <div className='max-md:hidden md:col-span-2 flex gap-20 w-full'>
         ...
         <div className='md:col-span-3 grid md:grid-cols-2 gap-5 xl:gap-20'>
            <div className=''>
               <p className='text-sm md:text-lg 2xl:text-xl font-bold mb-5 pr-2.5 relative'>
                  ارتباط با ما
                  <div className='absolute w-[5px] top-1/2 -translate-y-1/2 right-0 rounded-full h-2/3 bg-primary' />
