   ...
   return (
      <>
         <div className='p-5 mt-6 bg-white rounded-xl text-lg h-max'>
            <h3 className='text-sm xl:text-2xl font-bold lg:mt-2.5'>صورتحساب پرداختی</h3>
         ...
         <button className='p-5 mt-6 bg-white rounded-xl text-veri-xs md:text-sm xl:text-lg w-full flex-center'>
         ...
         <button className='p-5 mt-6 bg-white rounded-xl text-right text-veri-xs md:text-sm xl:text-lg w-full flex-center'>
            <div className='flex-center gap-2 2xl:gap-4 font-bold'>
