...
export default function ApplyDiscountCode() {
   return (
      <div className='p-5  bg-white rounded-xl text-lg h-max max-lg:mt-5'>
         <h2 className='text-sm md:text-lg xl:text-2xl mt-2.5'>اعمال کد تخفیف</h2>
         ...
         <div className='flex gap-4 xl:gap-5 mt-9 max-xl:text-xs'>
            <button className='bg-[#343434] rounded-2lg w-full py-5 text-white '>اعمال کد تخفیف</button>
